...
class LocationInputView: UIView {
    ...
    // Start Location View - точка рядом с текстовым полем
    ...
    // Linking View - черточка между locationIndicatorView и destinationIndicatorView
    ...
    // Destination Indicator View - точка рядом с текстовым полем
